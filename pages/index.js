...
function useBufferedData(url) {
	...
	return {
		...
		stale: buffer !== data,
		error,
		newTweets: () => setBuffer(data)
	};
}
function Home() {
	let { data, stale, error, newTweets } =
		useBufferedData('/api/tweets');
				...
				<div className="px-4 py-3 border-b border-gray-600">
					<div className="flex">
						...
						<div className="flex flex-col flex-1 min-w-0">
							...
							<div className="flex justify-between text-cool-gray-500 mt-2">
								<svg
									viewBox="0 0 24 24"
									className="w-5 h-5 p-px fill-current"
								>
									<g>
